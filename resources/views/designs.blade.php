                                ...
                                <div class="shop-item">
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <a class="shop-item-image">
                                            <img class="img-responsive" src="/assets/images/shop/ships/{{$design->image}}"  />
                                            <img class="img-responsive" src="/assets/images/shop/ships/{{$design->image}}" />
                                        </a>
                                        <!-- /product image(s) -->
                                    ...
                                    <div class="shop-item-summary text-center">
                                        ...
                                        <div class="shop-item-price">
                                            <h5>{{$design->price}} @if ($design->currency == "uridium") <small style="font-color:white;"><i class="glyphicon glyphicon-magnet"></i></small>@else <i class="glyphicon glyphicon-copyright-mark"></i> @endif</h5>
                                        </div>
                                        <!-- /price -->
                                    </div>
                                    <!-- buttons -->
                                    <form method="POST" action="{{ route('designs') }}">
                                        @csrf
                                        <input name="id" value="{{$design->loot_id}}" class="hidden"/>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-lg-pull-6 col-md-pull-6 col-sm-pull-6" style="
                    ...
                    <div class="side-nav margin-bottom-60">
                        ...
                        <ul class="list-group list-group-bordered list-group-noicon uppercase">
                            ...
                            <li class="list-group-item active"><a href="/shop/designs"><span class="size-11 text-muted pull-right">({{ $designs_total }})</span> DESIGNS</a></li>
                        </ul>
