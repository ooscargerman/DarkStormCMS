                                ...
                                <div class="shop-item">
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <a class="shop-item-image" href="shop-single-left.html">
                                            <img class="img-responsive" src="/assets/images/shop/ships/{{$equipment->image}}"  />
                                            <img class="img-responsive" src="/assets/images/shop/ships/{{$equipment->image}}" />
                                        </a>
                                        <!-- /product image(s) -->
                                    ...
                                    <div class="shop-item-summary text-center">
                                        ...
                                        <div class="shop-item-price">
                                            <h5>{{$equipment->price}} @if ($equipment->currency == "uridium") <small style="font-color:white;"><i class="glyphicon glyphicon-magnet"></i></small>@else <i class="glyphicon glyphicon-copyright-mark"></i> @endif</h5>
                                        </div>
                                        <!-- /price -->
                                    </div>
                                    <!-- buttons -->
                                    <form method="POST" action="{{ route('equipmentshop') }}">
                                        @csrf
                                        <input name="id" value="{{$equipment->loot_id}}" class="hidden"/>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-lg-pull-6 col-md-pull-6 col-sm-pull-6" style="
                    ...
                    <div class="side-nav margin-bottom-60">
                        ...
                        <ul class="list-group list-group-bordered list-group-noicon uppercase">
                            ...
                            <li class="list-group-item active"><a href="/shop/equipment"><span class="size-11 text-muted pull-right">({{ $equipment_total }})</span> EQUIPMENT</a></li>
